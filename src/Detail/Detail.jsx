...
import { getAllProduct, getProductDetail } from "../Redux/Actions/productAction";
								...
								<div className="border d-flex align-items-center justify-content-between py-1 px-3 bg-white border-white">
									...
									<div className="quantity">
										<button className="dec-btn p-0" style={{ cursor: "pointer" }}>
											<i className="fas fa-caret-left" onClick={minusQuantity}></i>
										</button>
										<input
										...
										<button className="inc-btn p-0" style={{ cursor: "pointer" }}>
											<i className="fas fa-caret-right" onClick={addQuantity}></i>
										</button>
									</div>
								</div>
							</div>
